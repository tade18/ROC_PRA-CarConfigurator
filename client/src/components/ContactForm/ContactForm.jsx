...
export default function ContactForm() {
  ...
  return (
    <>
      ...
      <form className="bg-yellow-300 p-6 rounded-lg shadow-lg w-1/2" ref={formRef} onSubmit={sendMail}>
        ...
        <div className="mb-4">
          <textarea name='message' placeholder="..a sem váš dotaz na nás" rows="10" className="w-full p-2 border-2 border-black rounded-md outline-none focus:ring-2 focus:ring-black"></textarea>
        </div>
